...
- User has entered the room through [useRoomState](https://web.sdk.qcloud.com/trtc/live/web/doc/zh/index.html#module-RoomState), please refer to [Room Management](https://write.woa.com/document/197379861957083136).
...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027337918/9407bc54dbe911f0a4f35254007c27c5.png)
...
In real business scenarios, you may need to initiate call invitations to users not yet in the room. Atomicx provides complete call system support, please see [In-Meeting Call](https://write.woa.com/document/197380078005506048).
...
<td rowspan="1" colSpan="1" >Contains user data in the room and user management interfaces.</td>
