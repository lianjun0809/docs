...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027337918/c09ab2a6e07f11f0a5a25254007c27c5.png)
...
## **Prerequisites**
- The user has completed login authentication through [useLoginState](https://web.sdk.qcloud.com/trtc/live/web/doc/zh/index.html#module-LoginState), please refer to [Integration Overview](https://write.woa.com/document/197379797539790848).

- The user has entered a room through [useRoomState](https://web.sdk.qcloud.com/trtc/live/web/doc/zh/index.html#module-RoomState), refer to [Room Management](https://write.woa.com/document/197379861957083136).
...
<table>
<tr>
<td rowspan="1" colSpan="1" >Property Name</td>
...
<tr>
<td rowspan="1" colSpan="1" >`layoutTemplate`</td>

<td rowspan="1" colSpan="1" >`RoomLayoutTemplate`</td>

<td rowspan="1" colSpan="1" >`RoomLayoutTemplate.GridLayout`</td>

<td rowspan="1" colSpan="1" >Video stream layout</td>
</tr>
</table>
...
<table>
<tr>
<td rowspan="1" colSpan="1" >Layout Mode</td>

<td rowspan="1" colSpan="1" >Enum Value</td>

<td rowspan="1" colSpan="1" >Description</td>
</tr>

<tr>
<td rowspan="1" colSpan="1" >Grid Layout</td>

<td rowspan="1" colSpan="1" >`RoomLayoutTemplate.GridLayout`</td>

<td rowspan="1" colSpan="1" >Default layout. All participant screens are evenly arranged, supports pagination when participants exceed 9 people.</td>
</tr>

<tr>
<td rowspan="1" colSpan="1" >Sidebar Layout</td>

<td rowspan="1" colSpan="1" >`RoomLayoutTemplate.SidebarLayout`</td>

<td rowspan="1" colSpan="1" >Main screen is prominently displayed, with other participant screens arranged in a sidebar format, suitable for speeches, reports, and other scenarios.</td>
</tr>

<tr>
<td rowspan="1" colSpan="1" >Top Bar Layout</td>

<td rowspan="1" colSpan="1" >`RoomLayoutTemplate.CinemaLayout`</td>

<td rowspan="1" colSpan="1" >Main screen is prominently displayed, with other participant screens arranged in a top bar format, suitable for speeches, reports, and other scenarios.<br></td>
</tr>
</table>
...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027337918/3728c9fce00311f09bba52540044a08e.png)

<table>
<tr>
<td rowspan="1" colSpan="1" >Slot Parameter</td>
...
<tr>
<td rowspan="1" colSpan="1" >`participant`</td>

<td rowspan="1" colSpan="1" >`RoomParticipant`</td>

<td rowspan="1" colSpan="1" >Participant object corresponding to the current video stream, containing real-time status information such as user's `userId`, `userName`, `role`, etc.</td>
</tr>

<tr>
<td rowspan="1" colSpan="1" >`streamType`</td>

<td rowspan="1" colSpan="1" >`VideoStreamType`</td>

<td rowspan="1" colSpan="1" >Distinguish whether the current is camera stream (Camera) or screen share stream (Screen)</td>
</tr>
</table>
...
<td rowspan="1" colSpan="1" >Contains room user data and user management interface.</td>
