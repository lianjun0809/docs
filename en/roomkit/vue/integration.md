...
Conference hosts can start a new conference by calling the `conference.start` interface. Other participants can refer to the description in [Step 6](https://write.woa.com/#061c9593-1112-4763-aff2-7289b3af0c41) and call the `conference.join` interface to join the conference.
...
Participants can join a conference started by the conference host in [Step 4](https://write.woa.com/#7e2fb3c2-2b17-4445-985d-4af641ff66be) by calling the `conference.join` interface and filling in the corresponding roomId parameter.
...
<td rowspan="1" colSpan="1" >Available Values</td>
