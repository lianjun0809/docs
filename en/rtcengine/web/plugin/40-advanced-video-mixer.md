...
| result | object            | Information about the success or failure of the parameters passed in this time, structured as follows:<table><tr><th>Name</th><th>Type</th><th>Description</th></tr><tr><td>successOptions</td><td>[Options](#options)</td><td>Successfully executed options for this update</td></tr><tr><td>failedDetails</td><td>MixFailedDetail[]</td><td>Detailed information about failed updates</td></tr></table> |
