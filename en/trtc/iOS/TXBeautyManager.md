...
| setMotionTmpl:inDir: | Select AI animation pendant |
| setMotionMute: | Mute while playing animation material |

## Enumeration Types
| Enumeration Types | Description |
| --- | --- |
| TXBeautyStyle | Skin smoothing algorithm |
...
| --- | --- | --- |
| TXBeautyStyleSmooth | 0 | Smooth: The algorithm is more aggressive, with a more noticeable skin smoothing effect, suitable for live shows. |
| TXBeautyStyleNature | 1 | Natural: The algorithm retains more facial details, providing a more natural skin smoothing effect, suitable for most live streaming scenarios. |
| TXBeautyStylePitu | 2 | YouTu: Provided by the YouTu Lab, it offers a skin smoothing effect between Smooth and Natural, retaining more skin details than Smooth while providing more smoothing than Natural. |
