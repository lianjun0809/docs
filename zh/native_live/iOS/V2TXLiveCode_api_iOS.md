...
`V2TXLiveCode.h` 是腾讯云直播SDK iOS/macOS平台的错误码和警告码定义文件，包含了推流器、播放器、混流、录制等功能的错误码分类和详细说明。
...
### ⚠️ V2TXLIVE_WARNING_CURRENT_ENCODE_TYPE_CHANGED - 编码器改变
...
### ⚠️ V2TXLIVE_WARNING_CURRENT_DECODE_TYPE_CHANGED - 解码器改变
