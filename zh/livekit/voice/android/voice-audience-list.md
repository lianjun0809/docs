...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027182232/12de3419c45811f09c26525400bf7822.png)
...
<td rowspan="1" colSpan="1" >代表观众模块的当前状态。其核心属性 `audienceList` 是一个 StateFlow，存储了观众列表的实时状态；`audienceCount` 则代表当前观众总数的实时状态。</td>
</tr>
...
<td rowspan="1" colSpan="1" >这是与观众列表功能交互的核心管理类。通过它，您可以获取观众列表快照、执行管理操作，并通过订阅其 `LiveAudienceListener` 来接收实时动态。</td>
</tr>
</table>
...
请参考 [开始直播](https://write.woa.com/document/192834878686547968) 集成 **AtomicXCore**，完成接入。
