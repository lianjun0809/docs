...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027182232/43473ccbb88211f0a808525400bf7822.png)
...
<td rowspan="1" colSpan="1" >被踢下麦用户`userID`。</td>
</tr>
...
#### 实现方式：
1. **主播移动麦位**：主播可以调用此接口将任意用户移动到指定麦位。此时 `userID` 传入目标用户的 ID，`targetIndex`是目标麦位索引，`policy` 参数来指定如果目标麦位有人时的移动策略，详见[接口参数](https://write.woa.com/#227e92a5-7552-41ae-b57c-2dab5b7de234)说明。
