...
![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027182232/a942e665b63f11f0a6c652540044a08e.png)
...
<td rowspan="1" colSpan="1" >代表弹幕模块的当前状态。其核心属性 `messageList` 是一个 `[Barrage]` 数组，按时间顺序存储了当前直播间的所有弹幕消息，是UI渲染的数据源。</td>
</tr>
...
请参考 [开始直播](https://write.woa.com/document/192834898445422592) 集成 **AtomicXCore**，完成接入。
...
2. 在左侧导航栏按照路径：**消息服务 Chat** >** 功能配置 **>** 群组配置 **> **群功能配置** >** 直播群新成员查看入群前消息量配置**进行导航。
   ...
   ![](https://write-document-release-1258344699.cos.ap-guangzhou.tencentcos.cn/100027182498/afe1de07a9a211f0a0a052540099c741.png)
